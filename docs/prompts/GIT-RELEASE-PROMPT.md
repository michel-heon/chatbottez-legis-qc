...
6. Tag nomenclature : v[version-du-manifest]-{COMPOSANT}_{FEATURE-DESCRIPTION}
...
### Commit
```
feat: release v[version-du-manifest] - [BUSINESS_TITLE]
...
### Tag Nomenclature
```
v[version-du-manifest]-{composant}_{feature-description}
